  ...
  <div class="space-y-0">
    ...
    >
      <div class="flex flex-col items-center">
        ...
        <div v-if="i < activity.length - 1" class="w-px flex-1 bg-border" />
      </div>
    ...
    <div v-if="activity.length === 0" class="flex flex-col items-center justify-center gap-2 py-8 text-muted-foreground">
