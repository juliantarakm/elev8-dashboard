...
export const phoneCalls: Record<string, PhoneCall[]> = {
  ...
  'conv-2': [
    { id: 'call-2-1', conversationId: 'conv-2', direction: 'outbound', status: 'completed', duration: 340, timestamp: '2026-04-24T16:45:00Z', from: 'Komang', to: '+44 7700 900123', note: 'Discussed airport transfer options', summary: 'Komang menghubungi James untuk membahas opsi airport transfer. James meminta penjemputan di bandara tanggal 28 April jam 2 siang. Sudah diatur driver dari pihak ketiga.' },
  ],
  'conv-3': [
    { id: 'call-3-1', conversationId: 'conv-3', direction: 'inbound', status: 'voicemail', duration: 23, timestamp: '2026-04-25T07:30:00Z', from: '+61 4 1234 5678', to: 'Komang', note: 'Asking about parking availability', summary: 'Emily meninggalkan voicemail menanyakan ketersediaan parkir di properti. Dia akan tiba besok dengan mobil rental dan ingin pastikan ada tempat parkir.' },
  ],
  'conv-5': [
    ...
    { id: 'call-5-3', conversationId: 'conv-5', direction: 'inbound', status: 'completed', duration: 95, timestamp: '2026-04-24T18:30:00Z', from: '+91 98765 43210', to: 'Komang', summary: 'Priya menelepon untuk melaporkan AC di kamar utama tidak dingin dan WiFi sering terputus. Komang akan koordinasi dengan tim maintenance untuk perbaikan besok pagi.' },
  ],
  'conv-8': [
    { id: 'call-8-1', conversationId: 'conv-8', direction: 'outbound', status: 'completed', duration: 128, timestamp: '2026-04-25T14:00:00Z', from: 'Komang', to: '+34 612 345 678', note: 'Pest control team dispatched', summary: 'Komang menghubungi Sofia untuk konfirmasi tim pest control sudah dikirim dan akan tiba dalam 30 menit. Sofia mengatakan masalahnya ada di area dapur. Komang minta maaf atas ketidaknyamanan.' },
  ...
  'conv-9': [
    { id: 'call-9-1', conversationId: 'conv-9', direction: 'outbound', status: 'completed', duration: 210, timestamp: '2026-04-25T12:30:00Z', from: 'Komang', to: '+82 10 1234 5678', note: 'Airport pickup confirmed for Friday 2 PM', summary: 'Komang menelepon Daniel untuk konfirmasi airport pickup hari Jumat jam 2 siang. Driver akan jemput di terminal kedatangan internasional dengan papan nama. Daniel mengonfirmasi penerbangan dari Seoul.' },
  ],
  'conv-12': [
    { id: 'call-12-1', conversationId: 'conv-12', direction: 'outbound', status: 'completed', duration: 275, timestamp: '2026-04-25T11:15:00Z', from: 'Komang', to: '+86 138 0013 8000', note: 'Extension availability confirmed, sent offer via app', summary: 'Komang menghubungi Amelia untuk konfirmasi perpanjangan menginap. Villa tersedia untuk 2 malam tambahan dengan harga yang sama. Amelia setuju dan Komang sudah kirim penawaran via app.' },
    { id: 'call-12-2', conversationId: 'conv-12', direction: 'inbound', status: 'completed', duration: 48, timestamp: '2026-04-25T10:55:00Z', from: '+86 138 0013 8000', to: 'Komang', summary: 'Amelia menelepon untuk menanyakan apakah bisa perpanjang menginap 2 malam lagi. Komang akan cek ketersediaan dan kabari segera.' },
  ],
  'conv-19': [
    ...
    { id: 'call-19-2', conversationId: 'conv-19', direction: 'inbound', status: 'voicemail', duration: 15, timestamp: '2026-04-26T09:16:00Z', from: '+7 495 123-45-67', to: 'Komang', note: 'Guest asking about early check-in, requesting callback', summary: 'Nina meninggalkan voicemail menanyakan apakah early check-in memungkinkan. Penerbangan dia tiba jam 9 pagi dan ingin check-in secepat mungkin. Meminta callback untuk konfirmasi.' },
  ],
  'conv-20': [
    { id: 'call-20-1', conversationId: 'conv-20', direction: 'outbound', status: 'completed', duration: 252, timestamp: '2026-04-25T16:00:00Z', from: 'Komang', to: '+52 55 1234 5678', note: 'Confirmed late checkout at 2 PM, guest was happy', summary: 'Komang menelepon Carlos untuk konfirmasi late checkout jam 2 sore. Carlos sangat senang dan berterima kasih atas fleksibilitasnya. Tidak ada permintaan lain.' },
    { id: 'call-20-2', conversationId: 'conv-20', direction: 'inbound', status: 'completed', duration: 85, timestamp: '2026-04-24T10:30:00Z', from: '+52 55 1234 5678', to: 'Komang', summary: 'Carlos menelepon untuk menanyakan apakah bisa late checkout karena penerbangan malam. Komang akan cek dan kabari.' },
  ],
}
