import type { OwnerReservation } from './owner-reservations'
...
export const mockOwnerReservations: OwnerReservation[] = [
  // Wayan (own-1, lst-1) — three guest bookings + two owner blocks.
  {
    ...
    guestName: 'Amelia Hart', checkIn: '2025-12-15', checkOut: '2025-12-20', status: 'confirmed',
  },
  {
    id: 'or-2', type: 'guest', listingId: 'lst-1', channel: 'booking',
    guestName: 'Daniel Ortega', checkIn: '2025-12-22', checkOut: '2025-12-26', status: 'confirmed',
  },
  {
    id: 'or-3', type: 'guest', listingId: 'lst-1', channel: 'direct',
    guestName: 'Hannah Okafor', checkIn: '2026-01-04', checkOut: '2026-01-08', status: 'pending',
  },
  {
  ...
  // I Putu (own-2) — two guest bookings that overlap on lst-3.
  {
    ...
    guestName: 'Ravi Singh', checkIn: '2025-12-10', checkOut: '2025-12-15', status: 'confirmed',
  },
  {
    id: 'or-7', type: 'guest', listingId: 'lst-3', channel: 'vrbo',
    guestName: 'Mia Tanaka', checkIn: '2025-12-13', checkOut: '2025-12-18', status: 'confirmed',
  },
  {
