<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 450" :width="size" :height="size" :style="svgStyle">
    <path style="fill: #E2261D;" d="M301.7,43.9h150.1c6.6,0,12.8,1.1,18.2,5.1c7.4,4.9,11.9,13.2,12.1,22.1c0.1,17,0.1,33.9,0.1,50.7l0.1,253.6
    ...
    <path style="fill: #FFFFFF;" d="M207.9,98h-28.2c-4.9,0-6,1.1-6.1,5.8V119c0,4.4,1.2,5.5,5.4,5.6l35.4,0.5c6.5,0.1,12.9,0,19.3,0.1
