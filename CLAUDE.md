...
- **Test Send dialog** — clicking Test Send opens a popup with: recipient phone input, template picker (5 hardcoded templates: Welcome, Check-in, Check-out, House Rules, Custom), auto-generated variable inputs from template placeholders, live WhatsApp-style message preview, and Send button (disabled until phone + body valid).
